...
// Google Auth Routes(passport)
userRoutes.get('/auth/google', userController.googleAuth);
userRoutes.get('/auth/google/callback', userController.googleAuthCallback);
userRoutes.get('/auth/login/success', userController.googleAuthSuccess);
